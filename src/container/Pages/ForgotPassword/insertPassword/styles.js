...
export default StyleSheet.create({
  ...
  inputCodeView: {width: '100%', alignItems: 'center', marginBottom: 5},
  ...
  // TextInput password
  iconRulesView: {alignItems: 'center', marginBottom: 5, paddingHorizontal: 55},
  iconShowRules: {position: 'absolute', left: 60, top: 35},
  iconTogglePassword: {position: 'absolute', right: 60, top: 38},
});
